export class SlotReel {
  ...
  async startSpin(resultMatrix = null) {
    ...
    this.updateSymbolTexture(targetIndex0, texture0);
    this.updateSymbolTexture(targetIndex1, texture1);
    this.updateSymbolTexture(targetIndex2, texture2);
    this.updateSymbolTexture(targetIndex3, texture3);
    this.updateSymbolTexture(targetIndex4, texture4);
    ...
    if (resultMatrix && resultMatrix[0] && resultMatrix[0][this.reelIndex] !== undefined && finalVisibleIndices.length === 3) {
      ...
      this.updateSymbolTexture(finalVisibleIndices[2], topSymbol);    // верхний
      this.updateSymbolTexture(finalVisibleIndices[1], middleSymbol); // средний
      this.updateSymbolTexture(finalVisibleIndices[0], bottomSymbol); // нижний
  ...
  updateSymbolTexture(symbolIndex, textureIndex) {
