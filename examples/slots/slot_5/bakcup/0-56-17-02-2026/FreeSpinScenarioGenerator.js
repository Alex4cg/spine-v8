...
export class FreeSpinScenarioGenerator {
  ...
  /**
   * В бонусной игре при каждом взрыве бомбы (multiplier или explode) начисляется +5 к мультипликатору жёлтого сундука.
   */
   ...
   * @param {number} yellowChestMultiplier — текущее значение до этого шага (накопленная сумма мультипликаторов бомб)
