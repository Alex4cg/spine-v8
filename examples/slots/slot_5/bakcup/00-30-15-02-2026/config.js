...
export const CONFIG = {
  ...
  // Режим интриги (CascadeManager): порог 3 скаттера — вкл, 4+ — выкл; множители задержек в коде
  INTRIGUE: {
    SCATTER_THRESHOLD: 3,       // Порог включения интриги (приземлилось 3 скаттера)
    ROW_MULTIPLIER: 1,          // ROW_DELAY × это значение при интриге
    COLUMN_MULTIPLIER: 3       // COLUMN_DELAY × это значение при интриге
  },
  ...
  FONTS: {
    STYLES: {
      ...
      FS_FONT: {
        ...
        fontWeight: 700,
        color: '#FFFF00',
        lineHeight: 48,  // 100% как в Figma
        letterSpacing: '0.03em',
        textShadow: { offsetX: 0, offsetY: 2, blur: 0, color: 'rgba(100, 0, 109, 0.5)' }
      }
    }
  },
