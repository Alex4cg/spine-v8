...
export class ScenarioGeneratorV3 {
  constructor(config) {
    ...
    this.bombSpinChance = config.bombSpinChance ?? 0.09;   // ~8.8% на спине (+20%)
    this.bombRefillChance = config.bombRefillChance ?? 0.03;  // ~2.9% при досыпке (+20%)
    ...
    this.scatterSpinChance = config.scatterSpinChance ?? 0.0088;   // ~0.88% на спине
    this.scatterRefillChance = config.scatterRefillChance ?? 0.0022;  // ~0.22% при досыпке
