...
import CoinIndicatorSpine from '@/assets/spine/coin_indicator/skeleton'

const TRACK_MAIN = 0

export default class CoinIndicator extends Container {
  #spine: Spine
  #isActive = false
  ...
  constructor() {
    ...
    this.#spine = this.addChild(new Spine(CoinIndicatorSpine.spineData))
  ...
  playAnticipation() {
    this.#isActive = true
    this.#spine.state.setAnimation(TRACK_MAIN, `anticipation`, true)
  }
